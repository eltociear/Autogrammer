...
export type JSONSchemaArray = JSONSchemaArrayNoItemType | JSONSchemaArrayMultipleItemType | JSONSchemaArraySingularItemType | JSONSchemaArrayBooleanItem;
...
export type GetConst = (key: string, opts?: {
    left?: boolean;
    right?: boolean;
}) => string;
